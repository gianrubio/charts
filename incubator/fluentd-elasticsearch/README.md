...
This chart bootstraps a [Fluentd](https://www.fluentd.ordeployment on a [Kubernetes](http://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
